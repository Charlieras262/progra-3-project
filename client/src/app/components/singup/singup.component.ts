...
export class SingupComponent implements OnInit {
  ...
  password: string;
  valPass: string;
  validations = { username: { msg: '', success: false }, email: { msg: '', success: false }, valCode: { msg: '', success: false }, password: { msg: '', success: false }, valPass: { msg: '', success: false } }
  ...
  onRegisterUser() {
    ...
    this.translate.get('register.valCode').subscribe(res => {
      this.validations.valCode = this.authService.checkField(this.valCode, 'valCode', res);
    });
    ...
    if (this.validations.username.success && this.validations.email.success && this.validations.valCode.success && this.validations.password.success && this.validations.valPass.success) {
      this.authService.authUserCredentials({ username: this.username, email: this.email, valCode: this.valCode, password: this.password }, 'r')
      .subscribe(res => {
      ...
      this.translate.get('register.valCode').subscribe(res => {
        this.authService.valField(this.validations.valCode.success, this.validations.valCode.msg, 'valCode', res);
      });
      this.translate.get('register.password').subscribe(res => {
